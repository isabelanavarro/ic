...
<div class="card3">
<form action="{{ url('/delete_user', $user->id)}}" method="POST" enctype="multipart/form-data" class="form-cad"> 
    <br><br>
...
<br>
   ...
   <br>
    ...
    <br>
    <div id="botao">
        <input type="submit" name="botao" value="Excluir" class="btn btn-primary" />
    </div>
